...
from custom_carball.json_parser.sanity_check.sanity_check import SanityChecker
...
def analyze_replay_file(replay_path: str, controls: ControlsCreator = None,
    ...
    :param logging_level: Sets the logging level globally across custom_carball
    ...
    if logging_level != logging.NOTSET:
        logging.getLogger('custom_carball').setLevel(logging_level)
...
if __name__ == '__main__':
    from custom_carball.tests.analysis_test import __test_replays
