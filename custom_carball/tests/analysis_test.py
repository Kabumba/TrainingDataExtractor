...
from custom_carball.analysis.utils.pandas_manager import PandasManager
...
def __test_replays(BASE_DIR):
    ...
    for filepath in glob.iglob(ROOT_DIR + '/**custom_carball/replays/*.replay', recursive=True):
